    ...
    <section className="auth-page">
      ...
      <div className="auth-scene">
        ...
        <div className="auth-scene-content">
          ...
          <p className="auth-brand-tagline">Join the village. Survive the night.</p>
        </div>
      ...
      <div className="auth-panel">
        <div className="auth-card">
          <div className="auth-card-header">
            ...
            <p className="auth-subtitle">Your legend begins here</p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="auth-field">
              ...
              <div className={`auth-input-wrap ${!passwordMatch ? "auth-input-error" : ""}`}>
                <svg className="auth-input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            ...
            <button type="submit" className="auth-btn-primary" disabled={!passwordMatch}>
          ...
          <p className="auth-switch">
            ...
            <a href="/auth/login" className="auth-switch-link">Log in</a>
          </p>
        </div>
      </div>
    </section>
